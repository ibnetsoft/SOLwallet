...
const en: Record<TranslationKey, string> = {
  ...
  'swap.from': 'From',
  'swap.to': 'To',
  'swap.switchDirection': 'Switch direction',
  'swap.amount': 'Amount',
  ...
  'trade.priceLabel': 'Price',
  'trade.amountLabel': 'Amount',
  ...
  'settings.logout': 'Logout / Switch Account',
  'settings.logoutDesc': 'Sign out of the current account. Wallet data is preserved; reopening will log in with the current Telegram account.',
