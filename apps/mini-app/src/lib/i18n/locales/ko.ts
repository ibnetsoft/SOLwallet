const ko: Record<string, string> = {
  ...
  'settings.logout': '로그아웃 / 계정 전환',
  'settings.logoutDesc': '현재 계정에서 로그아웃합니다. 지갑 데이터는 유지되며, 다시 열면 현재 Telegram 계정으로 로그인됩니다.',
  'settings.logoutDone': '로그아웃되었습니다.',
